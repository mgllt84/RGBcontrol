...
- Prise en charge DualSense : éclairage intégré au modèle 3D, témoins joueur et aperçu des commandes.
...
- Interface Control Deck entièrement recomposée : synthèse du setup, actions rapides, appareils et studio couleur.
- Pilote automatique centralisant profils par application, protection thermique, rythme jour/nuit et priorité manette.
- Centre de santé avec alertes Windows, détection des conflits RGB et plan visuel du setup réorganisable.
- Les vagues et dégradés traversent les appareils dans l'ordre défini sur le plan du setup.
